...
SECRET_KEY = 'django-insecure-ep)%qo#hy23ien*f-xwr!tu#oo3n11c6xhsce89kmcn$nc6h9f'
...
ROOT_URLCONF = 'Stage_Analysis.urls'
...
WSGI_APPLICATION = 'Stage_Analysis.wsgi.application'
...
# Ensure that the media root directory exists
